...
let MainPopup = class MainPopup {
    ...
    handleActiveWindow(tabs) {
        chrome.tabs.executeScript(tabs[0].id, { file: "./js/draw.js" }, () => {
        });
    }
    handleDraw() {
        alert('hello');
